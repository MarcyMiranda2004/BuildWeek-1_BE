...
public class DataTest {
    public static void inserisciDatiDiTest(EntityManager em) {
        ...
        // Test
        Amministratore admin3 = new Amministratore("Admin3", "Admin3", "admin3", "admin3");
        em.persist(admin3);

        Tessera tesseraAmministratore3 = new Tessera(LocalDate.now(), LocalDate.now().plusYears(1), admin3);
...
//
//        // Tessere
//        Tessera tesseraUtente1 = new Tessera(LocalDate.now(), LocalDate.now().plusYears(1), utente1);
//        Tessera tesseraUtente2 = new Tessera(LocalDate.now(), LocalDate.now().plusYears(1), utente2);
//        em.persist(tesseraUtente1);
//        em.persist(tesseraUtente2);
//
//        Tessera tessereAmministratore1 = new Tessera(LocalDate.now(), LocalDate.now().plusYears(1), admin1);
//        Tessera tesseraAmministratore2 = new Tessera(LocalDate.now(), LocalDate.now().plusYears(1), admin2);
//        em.persist(tessereAmministratore1);
//        em.persist(tesseraAmministratore2);
